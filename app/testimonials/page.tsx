...
export const metadata: Metadata = {
  ...
  description:
    "Lihat hasil nyata dan cerita transformasi lebih dari 100.000 pelanggan Melval Labskin. Before & after, rating, dan ulasan jujur dari customer kami.",
  alternates: { canonical: "/testimonials" },
};

const withBeforeAfter = TESTIMONIALS.filter((t) => t.beforeImage && t.afterImage);
      ...
      <section className="bg-gradient-luxury pb-16 pt-32 sm:pt-40">
        <div className="mx-auto max-w-7xl px-6">
          <SectionHeading
            ...
            title="Hasil Nyata dari Pelanggan Kami"
            description="Lebih dari 100.000 pelanggan telah merasakan transformasi bersama Melval Labskin. Ini adalah cerita mereka."
          />
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {STATS.map((stat) => (
              <div key={stat.label} className="rounded-brand-lg bg-white p-6 text-center shadow-card">
                <p className="font-playfair text-display-xs text-coral">
        ...
        <section className="py-section-sm sm:py-section">
          <div className="mx-auto max-w-7xl px-6">
            <SectionHeading
              ...
              description="Geser gambar untuk melihat perbandingan sebelum dan sesudah perawatan."
            />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <p className="mt-3 font-inter text-base text-brand-gray">
            Ceritakan pengalamanmu bersama Melval Labskin dan bantu pelanggan lain
            untuk berani memulai perjalanan kecantikan mereka.
          </p>
          <ButtonLink
            href={buildWhatsAppLink("Halo, saya ingin berbagi testimoni pengalaman saya di Melval Labskin.")}
            variant="primary"
            size="lg"
            className="mt-6"
          >
